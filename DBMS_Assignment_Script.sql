...
Sitting bus for a distance of 1000 KMs
*/
SELECT Passenger_Name, Price FROM PASSENGER ps 
...
FROM PASSENGER INNER JOIN (SELECT SUM(Distance) AS TotalDistance FROM PASSENGER) AS TOTAL;
